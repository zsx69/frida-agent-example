...
function monitor_constants(targetSo) {
    var const_array = [];
    var const_name = [];
    var const_addr = [['padding used in hashing algorithms (0x80 0 ... 0)', '0x3f008'], ['padding used in hashing algorithms (0x80 0 ... 0)', '0x3f048'], ['SHA256 / SHA224 K tabke', '0x31fa8'], ['SHA512 / SHA384 K table', '0x32108']];
